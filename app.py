...
file_path = os.path.abspath('ipynb/pipe_class2.pkl')  # Assuming 'pipe_class2.pkl' is directly within the 'Forest_Fires' directory
pickle_model = pickle.load(open(file_path, 'wb'))
@app.route('/')
def index():
    try:
